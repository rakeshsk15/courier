...
<head>
    ...
    <style>
        body {
            ...
            background-image: url('images/dlvry.jfif');
...
<body>
    <h1 align='center' style="margin: 15px; color: #b11226;font-weight: bold;font-family:'Times New Roman', Times, serif">Flash Courier</h1>
    <hr />
    <P align='center' style="font-weight: bold;color: #b11226;font-family:'Times New Roman', Times, serif">Deliveries at FLASH SPEED..⚡⚡</P>
    <div>
        <h5><a href="admin/adminlogin.php" style="float: right; margin-right:40px; color: #b11226; margin-top:0px">AdminLogin</a></h5>
    </div>
