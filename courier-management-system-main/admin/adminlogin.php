...
<body bgcolor="white">
    ...
    <h1 align='center' style="color: #b11226;font-size:60px">Admin Login</h1>
    <h6 align='center' style="color: #212121;font-weight: bold;font-size:15px">Welcome to FLASH Admin Page</h6>
